...
$email_pengirim = 'ardhianexe@gmail.com'; // Isikan dengan email pengirim
$nama_pengirim = 'Web Indocalcium'; // Isikan dengan nama pengirim
$email_penerima = $_POST['ardhianfahmi.sabani072@gmail.com']; // Ambil email penerima dari inputan form
...
$mail->Password = 'redexe93'; // Isikan dengan Password email pengirim
$mail->Port = 465;
$mail->SMTPAuth = true;
$mail->SMTPSecure = 'ssl';
// $mail->SMTPDebug = 2; // Aktifkan untuk melakukan debugging
$mail->setFrom($ardhianexe@gmail.com, $Indocalciumweb);
$mail->addAddress($ardhianfahmisab@gmail.com, '');
...
$mail->Subject = $subjek;
$mail->Body = $content;
$mail->AddEmbeddedImage('logo.png', 'logo_indocalcium', 'logo.png'); // Aktifkan jika ingin menampilkan gambar dalam email
